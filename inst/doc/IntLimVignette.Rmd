...
Additionally, the metabMetaData, geneMetaData, and SampleMetaData need to contain an 'id' column that contains the same of the features (metabolite or gene) or sample (sample id, name, etc).
